...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if($ins->execute()){
		header('location:../extend/alertas.php?msj=Cliente agregado&c=cli&p=in&t=success');
	} else {
		header('location:../extend/alertas.php?msj=No se pudo agregar el cliente&c=cli&p=in&t=error');
	}
