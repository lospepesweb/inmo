...
<div class="container">
  <div class="row">
  <div class="col s12">
    <h5 class="header"><?php echo $f['tipo_inmueble'] ?> EN <?php echo $f['operacion'] ?>, PRECIO: <?php echo number_format($f['precio'], 2,",",".") ?></h5>
    <div class="card horizontal">
      ...
      <div class="card-stacked">
        <div class="card-content">
          <p><b>UBICACION:</b> <?php echo $f['calle_num'].' '.$f['barrio'].', '.$f['departamento'].' '.$f['provincia'] ?></p>
          <p><b>DESCRIPCION:</b> <?php echo $f['comentario_web'] ?></p>
          <p><b>DORMITORIOS:</b> <?php echo $f['dormitorios'] ?></p>
          ...
          <div class="row">
            ...
            <div class="col s4">
              <?php
              $asesor = $f['asesor'];
              $sel_ase = $con->prepare("SELECT correo, foto FROM usuarios WHERE nombre = ? ");
      ...
      <div class="card">
        <div class="card-content">
          <div class="row">
            ...
            <?php $sel_img = $con->prepare("SELECT * FROM fotos WHERE id_propiedad = ? ");
      ...
      <div class="card">
        <div class="card-content">
          <span class="card-title">UBICACIÓN</span>
            <div class="row">
              <div class="col s6">
                <iframe src="admin/propiedades/mapa.php?mapa=<?php echo $f['mapa'] ?>" width="100%" height="500" frameborder="0" class="z-depth-1"></iframe>  
              </div>
             <div class="col s6">
  ...
  <script>
    //iniciarlizar materialboxed (zoom de las fotos secundarias)
    $('.materialboxed').materialbox();

    //envio del formulario de mensaje por ajax
